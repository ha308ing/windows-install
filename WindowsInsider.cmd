...
FOR /F "USEBACKQ" %%i IN (`dir /ad /b *_convert`) DO (
  SET isoDir=%%i
)
...
DISM /MOUNT-IMAGE /IMAGEFILE:install.wim /MOUNTDIR:mount
...
SET regsPath=E:\OneDrive\arkaev\windows-custom-setup\reg-offline
...
:yesVHD
(
ECHO sel vdisk file=B:\win11-insider.vhdx
ECHO attach vdisk
ECHO clean
ECHO convert gpt
ECHO sel part 1
...
ECHO format quick fs=fat32 label="insider-efi"
ECHO create part msr size=16
ECHO create part pri size=131522
ECHO format quick fs=ntfs label="insider-system"
ECHO assign letter=F
ECHO shrink minimum=450
ECHO create part pri size=450
ECHO format quick fs=ntfs label="insider-recovery"
ECHO set id="de94bba4-06d1-4d40-a16a-bfd50179d6ac"
ECHO create part pri
ECHO format quick fs=ntfs label="insider-data"
...
bcdboot F:\Windows
bcdedit /set {default} description "Windows 11 Insider"
